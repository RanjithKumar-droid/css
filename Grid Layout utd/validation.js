...
function validate() {
  ...
  if (stockname.value == "") {                // this will be modified
  ...
  if(category.value == ""){
    ...
    category.style.padding = "3px 0px 3px 3px";
    category.style.margin = "5px 1px 3px 0px";
    category.style.boxShadow = " 0 0 5px red";
